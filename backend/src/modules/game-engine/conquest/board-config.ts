...
// artwork). Territory names and their specific subdivision/adjacency
// scheme are original, not a reproduction of Risk's specific 42-territory
// list.
...
export const TERRITORIES: TerritoryDef[] = [
  // North America (7)
  { id: 'icemark', name: 'Icemark', continentId: 'north_america', x: 180.61, y: 110.37 },
  { id: 'glacier_reach', name: 'Glacier Reach', continentId: 'north_america', x: 417.63, y: 79.43 },
  { id: 'frozen_cape', name: 'Frozen Cape', continentId: 'north_america', x: 334.95, y: 139.08 },
  { id: 'tundrafall', name: 'Tundrafall', continentId: 'north_america', x: 248.58, y: 129.77 },
  { id: 'whitepeak', name: 'Whitepeak', continentId: 'north_america', x: 207.36, y: 180.18 },
  { id: 'snowvale', name: 'Snowvale', continentId: 'north_america', x: 281.46, y: 184.43 },
  { id: 'coldharbor', name: 'Coldharbor', continentId: 'north_america', x: 222.16, y: 233.46 },

  // South America (6)
  { id: 'vineholt', name: 'Vineholt', continentId: 'south_america', x: 314.85, y: 286.77 },
  { id: 'canopy_reach', name: 'Canopy Reach', continentId: 'south_america', x: 331.38, y: 315.65 },
  { id: 'mistwood', name: 'Mistwood', continentId: 'south_america', x: 380.06, y: 344.81 },
  { id: 'serpents_delta', name: "Serpent's Delta", continentId: 'south_america', x: 287.06, y: 331.59 },
  { id: 'junglecrown', name: 'Junglecrown', continentId: 'south_america', x: 326.09, y: 363.93 },
  { id: 'verdant_hollow', name: 'Verdant Hollow', continentId: 'south_america', x: 332.53, y: 428.64 },

  // Europe (7)
  { id: 'cinderpeak', name: 'Cinderpeak', continentId: 'europe', x: 493.03, y: 130.87 },
  { id: 'volcarest', name: 'Volcarest', continentId: 'europe', x: 532.54, y: 106.9 },
  { id: 'steppewatch', name: 'Steppewatch', continentId: 'europe', x: 512.13, y: 149.67 },
  { id: 'ironridge', name: 'Ironridge', continentId: 'europe', x: 525.17, y: 168.94 },
  { id: 'blackspire', name: 'Blackspire', continentId: 'europe', x: 547.16, y: 137.23 },
  { id: 'grayridge', name: 'Grayridge', continentId: 'europe', x: 571.77, y: 143.7 },
  { id: 'cragmoor', name: 'Cragmoor', continentId: 'europe', x: 555.37, y: 169.09 },

  // Africa (7)
  { id: 'duneshore', name: 'Duneshore', continentId: 'africa', x: 500, y: 208.06 },
  { id: 'emberwaste', name: 'Emberwaste', continentId: 'africa', x: 580.99, y: 221.4 },
  { id: 'sandfall', name: 'Sandfall', continentId: 'africa', x: 541.61, y: 257.16 },
  { id: 'scorchpeak', name: 'Scorchpeak', continentId: 'africa', x: 620.43, y: 280.11 },
  { id: 'oasis_vale', name: 'Oasis Vale', continentId: 'africa', x: 561.84, y: 312.46 },
  { id: 'redrock', name: 'Redrock', continentId: 'africa', x: 601.17, y: 315.7 },
  { id: 'sunspire', name: 'Sunspire', continentId: 'africa', x: 564.46, y: 397.16 },

  // Asia (9)
  { id: 'port_meridian', name: 'Port Meridian', continentId: 'asia', x: 632.55, y: 114.21 },
  { id: 'sunset_bay', name: 'Sunset Bay', continentId: 'asia', x: 782.05, y: 113.87 },
  { id: 'goldshore', name: 'Goldshore', continentId: 'asia', x: 619.8, y: 208.66 },
  { id: 'ashport', name: 'Ashport', continentId: 'asia', x: 664.93, y: 151.5 },
  { id: 'ridgeway', name: 'Ridgeway', continentId: 'asia', x: 713.05, y: 235.65 },
  { id: 'stonebridge', name: 'Stonebridge', continentId: 'asia', x: 773.83, y: 195.35 },
  { id: 'lakehaven', name: 'Lakehaven', continentId: 'asia', x: 785.73, y: 258.86 },
  { id: 'riverrun', name: 'Riverrun', continentId: 'asia', x: 848.79, y: 191.44 },
  { id: 'highmarch', name: 'Highmarch', continentId: 'asia', x: 817.65, y: 312.37 },

  // Oceania (6)
  { id: 'pearl_isle', name: 'Pearl Isle', continentId: 'oceania', x: 830.84, y: 384.05 },
  { id: 'reefhaven', name: 'Reefhaven', continentId: 'oceania', x: 869.87, y: 349.25 },
  { id: 'tideport', name: 'Tideport', continentId: 'oceania', x: 898.63, y: 382.5 },
  { id: 'saltmere', name: 'Saltmere', continentId: 'oceania', x: 860.59, y: 414.35 },
  { id: 'driftcay', name: 'Driftcay', continentId: 'oceania', x: 901.28, y: 324.48 },
  { id: 'stormatoll', name: 'Stormatoll', continentId: 'oceania', x: 936.32, y: 429.54 },
];
