...
export const CONTINENTS: ContinentDef[] = [
  ...
  { id: 'oceania', name: 'Oceania', bonus: 2 },
];
...
// Territory counts per continent (North America 9, South America 4,
// Europe 7, Africa 6, Asia 12, Oceania 4 -- 42 total) match real-world
// continent proportions; the specific regions, names, and adjacency
// remain this project's own design, not a reproduction of any existing
// game's board.
export const TERRITORIES: TerritoryDef[] = [
  ...
  { id: 'hudson_bay', name: "Hudson Bay", continentId: 'north_america', x: 312.22, y: 115.73 },
  ...
  { id: 'mosquito_coast', name: "Mosquito Coast", continentId: 'north_america', x: 266.21, y: 264.67 },
...
const EDGES: Array<[string, string]> = [
  ...
  ['snowvale', 'coldharbor'],
  ['hudson_bay', 'tundrafall'],
  ['hudson_bay', 'frozen_cape'],
  ['hudson_bay', 'glacier_reach'],
  ['coldharbor', 'mosquito_coast'],

  // South America
  ['vineholt', 'canopy_reach'],
  ['vineholt', 'serpents_delta'],
  ['canopy_reach', 'serpents_delta'],
  ['canopy_reach', 'verdant_hollow'],
  ...
  ['mosquito_coast', 'vineholt'], // Panama
